...
type Props = NativeStackScreenProps<WorkerRootStackParamList, "ReportChat">;
...
/** Reports either one specific chat message (messageId + messageText passed)
 * or the other party generally (both omitted, reached from ChatScreen's
 * header menu) — see docs/prds/chat-safety.md §6a/§6b. Layout mirrors the
 * customer app's existing ReportProblemScreen. */
    ...
    <Screen>
      <View style={styles.headerRow}>
        ...
        <ThemedText variant="subtitle">
          {messageText ? "Report message" : "Report user"}
        </ThemedText>
        <View style={{ width: 24 }} />
      </View>
