...
const ERASED = [
  ...
  "Your ID document and any certificates you uploaded",
  "Your saved payout method",
];

const RETAINED = [
  "Your job history, ratings and customer reviews",
  "Your messages",
];

/** D1 — warning screen, first step of account deletion. "What is erased"
    ...
    <Screen>
      ...
      >
        ...
        <ThemedText variant="caption" style={styles.footnote}>
          You cannot undo this. Working with Prism again would mean signing up and verifying
          your ID from scratch{firstName ? `, ${firstName}` : ""}.
        </ThemedText>
